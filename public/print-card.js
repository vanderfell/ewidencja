...
/* WYŚRODKOWANIE: kody absencji w nieobecnościach */
.nieobecnosci.main-absence td:not(.small-label):not(.label) {
  text-align: center !important;
  vertical-align: middle !important;
}

/* WYŚRODKOWANIE: komórki Razem faktyczny czas pracy: i "w godz", "w dniach" */
.small-day td, .small-day th,
.small-absence td, .small-absence th {
  text-align: center !important;
  vertical-align: middle !important;
}
